...
if &background ==# 'dark'
  ...
  "hi Normal guifg=#b8b6bc guibg=#080808 gui=NONE cterm=NONE
  "#000000
  "#15161b
  "#181818
  hi Normal guifg=#b1b0b5 guibg=#000000 gui=NONE cterm=NONE
  ...
  hi Pmenu guifg=#ffffff guibg=#252525 gui=NONE cterm=NONE
  hi PmenuSbar guifg=#dadada guibg=#707070 gui=NONE cterm=NONE
  hi PmenuSel guifg=#ffffff guibg=#0909e4 gui=NONE cterm=NONE
  ...
  hi Comment guifg=#4f6d6a guibg=NONE gui=bold cterm=bold
  ...
  hi Todo guifg=#00ffaf guibg=NONE
...
" vim: et ts=2 sw=2
"
"" Inside c.vim (or the relevant syntax file)
syn match cMemberAccess "\.\w\+" contains=cBlock,cBlockItem,cParen
syn match cMemberAccess "->\w\+" contains=cBlock,cBlockItem,cParen

hi cMemberAccess guifg=Green ctermfg=NONE
